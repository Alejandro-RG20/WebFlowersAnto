<?php
/**
 * Texto de las páginas legales: privacidad, términos y devoluciones.
 *
 * Vive aparte de `legal.php` para que haya una sola fuente: la página lo
 * pinta y el asistente de compras lo lee cuando un cliente pregunta por una
